<?php
 function formulaire($tableAjout, $erreur=false){
    ...
    if($erreur)
    {
        //Formulaire d'enregistrement d'un prospect si l'utilisateur n'a pas remplis tous les champs.   
    ...
    {
        //Formulaire d'enregistrement d'un prospect si l'utilisateur arrive sur la page.
