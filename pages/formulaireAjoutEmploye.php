...
<div class="register-box">
  <div class="register-logo">
    <a href="../index.php"><b>Monitoring</b></a>
  </div>
  <div class="register-box-body">
    <p class="login-box-msg">Inscription</p>

    <form action="?page=confirmationCreation" method="POST">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="Mot de passe" name="motdepasse2">
